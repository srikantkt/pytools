class TableFormatter:
    ...
    def __init__(self, column_names=['column_1', 'column_2']):
        ...
        self.dataRowSeparation = False

    def setDataRowSeparation(self, separate=False):
...
if __name__ == "__main__":
    ...
    #tf.setDataRowSeparation(True)
    #tf.setPaddingString('*')
    tf.addRowData(['val1', 'value2', 'value 3'])
    tf.addRowData(['one is alone', 'two is a company', 'three is a crowd'])
    tf.addRowData(['test'])
    tf.addRowData([1, 'two', False, (3, 4, True)])
    tf.addRowData(['test', 'value2', 'value 3', 'value2', 'value 3'])
